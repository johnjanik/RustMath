...
impl<F: Field> FunctionFieldIdealRational<F> {
    /// Create a new ideal
...
impl<F: Field> FunctionFieldIdealInfiniteRational<F> {
...
impl<F: Field> Default for FunctionFieldIdealInfiniteRational<F> {
    fn default() -> Self {
        Self::new()
    }
}
