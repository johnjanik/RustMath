...
RHO = {
    ...
    'c':  "0.980867507217598955388724936481076359729405754",
    'c3': "0.983364506939735093007662848181229795356815654",   # mirror pole chart, coset 4
}
BIN = {
    'a':  SW + "mB_a_N1100.bin",
    'b':  SW + "mB_b_N6900.bin",
...
Z_C3 = mp.mpc('-0.793538482569228956003002774509736302229259206',
              '0.608520070894728592568281209719200629678206803')
CENTER = {'a': Z_A, 'b': Z_B, 'b2': Z_B2, 'c': Z_C, 'c3': Z_C3}
